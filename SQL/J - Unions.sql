...
-- For the UNION to work, however, the number, order and data type
-- of the columns in the SELECT statments must match.
-- UNION are rarely used, but are helpful for certain situations.
